...
<?php 
     // include the header for the banner
     include "./header.html" ;
 ?>
...
<body>
     ...
     <div class="jumbotron">
          <div class="display-4" id="infoListName" style="text-align: center;">
               <div id="favouriteStar" style="display: none"><a href="javascript:saveFavourites();"><i id="favStar" class="far fa-star"></i></a></div>
          </div>
          <div class="lead" id="infoPC-stores" style="text-align: center;"></div>    
     </div>

     <!-- Switch to toggle to AI functionality -->
     <div class="AIswitch">
          <h6> Toggle to receive personalized lists based on past store reviews! </h6>
          <label class="switch">
               <input type="checkbox">
     ...
     <div class="listTable">
          ...
          <form id="groceryItemForm">  
               ...
               <table id="groceryListTable" class="table table-striped table-bordered">
                    <thead>
                         <tr>
                              ...
                              <th id="validto">Coupon Expiry Date</th>
                              <th></th>
                              <th></th>
                         </tr>
                    </thead>
               ...
               <button class="btn btn-dark" id="finishBtn" style="margin: 5px;" onclick="finishList();" disabled>Mark as Complete</button>
               ...
               <div class="modal-content">
                    ...
                    <div id="reviewForm" class="main">
                         <div id="review">
                              ...
                              <button type="button" id="submitReviewBtn" class="btn btn-dark" onclick="submitReview();">Submit Review</button>
                         </div>
                    </div>
               </div>
          </div>
